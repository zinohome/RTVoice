...
export default function VoicesPage() {
  ...
  const { data: cfgData } = useQuery<{ default_voice: string }>({
  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      {isLoading ? (
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {voices.map((v) => {
            const isDefault = defaultVoice ? v === defaultVoice : false;
            const isSettingDefault = setDefaultMut.isPending && setDefaultMut.variables === v;
            return (
